...
Проект включает библиотеку `optimlib` с методами оптимизации и средства
проведения экспериментов. В каталогах лабораторных находятся постановки задач,
конфигурации, скрипты запуска и отчёты.
...
Презентации: [ЛР2–3](presentation/presentation_labs_2_3.pdf)
и [ЛР4–5](presentation/presentation_labs_4_5.pdf).
