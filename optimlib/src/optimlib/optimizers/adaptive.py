...
from optimlib.exceptions import FunctionEvaluationError, StopOptimization
...
class AdaptiveOptimizer(GradientOptimizer):
    ...
    def minimize(self, func: ObjectiveFunction, config: OptimizerConfig) -> OptimizationResult:
        ...
        try:
            ...
            message = exc.message
            converged = True
        except (FunctionEvaluationError, FloatingPointError, OverflowError) as exc:
